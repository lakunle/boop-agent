...
| `TELEGRAM_WEBHOOK_SECRET` | optional | Strongly recommended. Auth gate for /telegram/webhook — without it, anyone who knows the URL can inject inbound updates. Auto-generated by `npm run setup`. |
